System.register([], function (exports_1, context_1) {
    "use strict";
    var noop, _WINDOW, _DOCUMENT, _MUTATION_OBSERVER, _PERFORMANCE, _ref, _ref$userAgent, userAgent, WINDOW, DOCUMENT, MUTATION_OBSERVER, PERFORMANCE, IS_BROWSER, IS_DOM, IS_IE, NAMESPACE_IDENTIFIER, UNITS_IN_GRID, DEFAULT_FAMILY_PREFIX, DEFAULT_REPLACEMENT_CLASS, DATA_FA_I2SVG, DATA_FA_PSEUDO_ELEMENT, DATA_PREFIX, DATA_ICON, HTML_CLASS_I2SVG_BASE_CLASS, TAGNAMES_TO_SKIP_FOR_PSEUDOELEMENTS, PRODUCTION, oneToTen, oneToTwenty, ATTRIBUTES_WATCHED_FOR_MUTATION, RESERVED_CLASSES, initial, _default, config, w, namespace, functions, listener, loaded, d, meaninglessTransform, idPool, ALL_SPACE, noop$1, p, preamble, begin, end, perf, bindInternal4, reduce, styles, shims, _byUnicode, _byLigature, _byOldName, build, styles$1, emptyCanonicalIcon, noop$2, mutators, disabled, mo, parseTransformString, blankMeta, FILL, ANIMATION_BASE, RING, OPACITY_ANIMATE, DOT, QUESTION, EXCLAMATION, missing, styles$2, LAYERS_TEXT_CLASSNAME, FONT_FAMILY_PATTERN, STYLE_TO_PREFIX, FONT_WEIGHT_TO_PREFIX, baseStyles, Library, library, noAuto, _cssInserted, dom, parse, icon, text, counter, layer, api, autoReplace;
    ...
    function observe(options) {
        ...
        var treeCallback = options.treeCallback, nodeCallback = options.nodeCallback, pseudoElementsCallback = options.pseudoElementsCallback, _options$observeMutat = options.observeMutationsRoot, observeMutationsRoot = _options$observeMutat === void 0 ? DOCUMENT.body : _options$observeMutat;
