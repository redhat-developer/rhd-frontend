...
<div class="control" id="control">
    ...
    addGroups() {
        let groups = this.filters && this.filters.facets ? this.filters.facets : [], len = groups.length;
        for (let i = 0; i < len; i++) {
            let group = new DPSearchFilterGroup(), groupInfo = groups[i], gLen = groupInfo.items.length;
