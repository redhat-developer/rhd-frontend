...
export default class RHDPSearchApp extends HTMLElement {
    constructor() {
        super();
        this._name = 'Search';
        this._oburl = '../rhdp-apps/onebox/onebox.json';
    ...
    <div class="large-24 medium-24 small-24 columns searchpage-middle">
        ...
        this.urlEle = new RHDPSearchURL();
        this.query = new RHDPSearchQuery();
        this.box = new RHDPSearchBox();
        this.count = new RHDPSearchResultCount();
        this.filters = new RHDPSearchFilters();
        this.active = new RHDPSearchFilters();
        this.modal = new RHDPSearchFilters();
        this.onebox = new RHDPSearchOneBox();
        this.results = new RHDPSearchResults();
        this.sort = new RHDPSearchSortPage();
        this.filterObj = {
            term: '',
            facets: [
