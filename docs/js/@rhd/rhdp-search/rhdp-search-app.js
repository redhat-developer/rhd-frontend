...
(function (factory) {
    ...
    var rhdp_search_url_1 = __importDefault(require("./rhdp-search-url"));
    var rhdp_search_query_1 = __importDefault(require("./rhdp-search-query"));
    var rhdp_search_box_1 = __importDefault(require("./rhdp-search-box"));
    var rhdp_search_result_count_1 = __importDefault(require("./rhdp-search-result-count"));
    var rhdp_search_filters_1 = __importDefault(require("./rhdp-search-filters"));
    var rhdp_search_onebox_1 = __importDefault(require("./rhdp-search-onebox"));
    var rhdp_search_results_1 = __importDefault(require("./rhdp-search-results"));
    var rhdp_search_sort_page_1 = __importDefault(require("./rhdp-search-sort-page"));
