export default class RHDPOSDownload extends HTMLElement {
    constructor() {
        ...
        this._macURL = "";
        this._winURL = "";
        this.stage_download_url = 'https://developers.stage.redhat.com';
        this.productDownloads = {
        ...
        this.template = (strings, product, downloadUrl, platform, version) => {
        ...
        this.downloadsTemplate = (strings, product, downloadUrl, platform, version) => {
            return `<div class="large-8 columns download-link">
                    <a class="button heavy-cta" href="${downloadUrl}">
                        <i class="fa fa-download"></i> Download</a>
                    <div class="version-name">${product} ${version} ${this.displayOS ? `for ${platform}` : ''}</div>
